...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      relations: [['Relation00', 'Relation01', ''], ['', 'Relation11', 'Relation12'], ['', '', 'Relation22']]
    };
  },
...
var render = function() {
  ...
  return _c("table", { staticClass: "table table-striped" }, [
      ...
      _c(
        ...
        [
          _c("th", { attrs: { scope: "col" } }, [
            _vm._v("Total de Clases: " + _vm._s(_vm.classes.length))
          ]),
          _vm._v(" "),
          _vm._l(_vm.classes, function(_class) {
            return _c("th", { attrs: { scope: "col" } }, [
              _vm._v(_vm._s(_class))
            ])
          })
        ],
        2
    ...
    _c(
      "tbody",
      _vm._l(_vm.objectives, function(objective, index) {
        return _c(
          "tr",
          [
            _c("th", { attrs: { scope: "row" } }, [_vm._v(_vm._s(objective))]),
            _vm._v(" "),
            _vm._l(_vm.relations[index], function(relation) {
              return _c("td", [_vm._v(_vm._s(relation))])
            })
          ],
          2
        )
...
__webpack_require__(/*! C:\Users\Renzo\projects\gantt\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Renzo\projects\gantt\resources\sass\app.scss */"./resources/sass/app.scss");
